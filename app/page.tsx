...
export default function Home() {
  ...
  return (
    <main className="overflow-hidden bg-[#f9f8f4] text-[#19221c]">
      ...
      <section id="avis" className="px-5 py-24 lg:px-8 lg:py-36"><div className="mx-auto max-w-7xl"><div className="grid gap-12 lg:grid-cols-12"><div className="lg:col-span-4"><p className="eyebrow">Vos mots</p><h2 className="mt-5 font-serif text-5xl tracking-[-.04em]">Adoré ici.</h2><div className="mt-10 border-l-2 border-[#9b4332] pl-5"><p className="text-xs font-bold uppercase tracking-[.16em]">Note Google</p><p className="mt-2 font-serif text-4xl">★★★★★</p><p className="mt-2 text-sm text-[#5c685f]"><b className="text-[#1c2b22]">5,0 / 5</b> · plus de 30 avis</p></div></div><div className="grid gap-4 md:grid-cols-3 lg:col-span-8">{["Les sushis sont vraiment excellents, d’une très belle qualité, et proposés à un prix plus que raisonnable. Une belle adresse à retenir !", "Quel plaisir que cette ouverture ! Une cuisine maison généreuse et de très haute qualité le tout à un prix plus que raisonnable.", "Petit restaurant par sa taille, grand par le goût !"].map((review, i) => <motion.figure initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * .1 }} key={review} className="flex min-h-64 flex-col justify-between border border-[#dfe2dc] bg-white p-7"><div><div className="text-sm tracking-[.1em] text-[#9b4332]">★★★★★</div><blockquote className="mt-7 font-serif text-2xl leading-snug tracking-[-.02em]">“{review}”</blockquote></div><figcaption className="text-[10px] font-bold uppercase tracking-[.16em] text-[#798178]">Avis Google</figcaption></motion.figure>)}</div></div><div className="mt-8 text-center lg:pl-[33.333%]"><a href="https://www.google.com/maps/place/Buriram+Tha%C3%AF+food+%26+Torok+sushi/@48.3226947,0.821032,17z/data=!4m17!1m8!3m7!1s0x47e3b736e99d0e51:0xf6edda9d63249db2!2splace+du+g%C3%A9n%C3%A9ral,+10+Place+St+Pol,+28400+Nogent-le-Rotrou!3b1!8m2!3d48.3226947!4d0.821032!16s%2Fg%2F11c4dp5cxt!3m7!1s0x47e3b71851543011:0xe92a88a288095904!8m2!3d48.3226956!4d0.8210357!9m1!1b1!16s%2Fg%2F11xw9c_6m0?entry=ttu&g_ep=EgoyMDI2MDkwMi4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#1c2b22] px-6 py-3.5 text-[11px] font-bold uppercase tracking-[.15em] text-white transition hover:bg-[#9b4332]">Voir tous les avis Google<Arrow /></a></div></div></section>

      <section id="contact" className="bg-[#e8e7e0] px-5 py-24 lg:px-8 lg:py-32"><div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-2 lg:gap-24"><div><p className="eyebrow">Nous trouver</p><h2 className="mt-5 font-serif text-5xl tracking-[-.04em]">Venez partager un moment.</h2><div className="mt-12 grid gap-9 sm:grid-cols-2"><div><p className="contact-label">Adresse</p><address className="mt-3 not-italic leading-relaxed">10 Place du Général Saint-Pol<br />28400 Nogent-le-Rotrou<br />France</address></div><div><p className="contact-label">Téléphone</p><a href="tel:+33763130999" className="mt-3 block text-lg underline decoration-[#9b4332] underline-offset-4">07 63 13 09 99</a></div><div className="sm:col-span-2"><p className="contact-label">Horaires d&apos;ouverture</p><p className="mt-3 text-sm leading-relaxed">Du mardi au dimanche<br />Service du midi & du soir<br /><span className="text-[#687268]">Appelez-nous pour les horaires du jour.</span></p></div></div><div className="mt-10 flex flex-wrap gap-3"><a target="_blank" rel="noreferrer" href="https://maps.google.com/?q=10+Place+du+General+Saint-Pol+28400+Nogent-le-Rotrou" className="rounded-full bg-[#1c2b22] px-6 py-3.5 text-[11px] font-bold uppercase tracking-[.15em] text-white">Itinéraire<Arrow /></a><a href="tel:+33763130999" className="rounded-full border border-[#1c2b22] px-6 py-3.5 text-[11px] font-bold uppercase tracking-[.15em]">Appeler</a></div></div><div className="relative min-h-[380px] overflow-hidden bg-[#cbd1c5]"><iframe title="Carte de Buriram Thaï Food & Torok Sushi" src="https://www.google.com/maps?q=BURIRAM%20Tha%C3%AF%20Food%20%26%20Torok%20Sushi%2C%2010%20place%20Saint-Pol%2C%20Nogent-le-Rotrou&output=embed" className="absolute inset-0 h-full w-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen /><a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps?cid=17793118072318762418" aria-label="Ouvrir l’adresse dans Google Maps" className="absolute bottom-7 left-7 bg-[#f9f8f4] px-5 py-4"><p className="text-[10px] font-bold uppercase tracking-[.16em]">Buriram Thaï Food</p><p className="mt-1 text-xs text-[#5d675f]">10 Place du Général Saint-Pol</p></a></div></div></section>
